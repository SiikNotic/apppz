...
export function ProductsTab() {
  ...
  return (
    <div>
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {item.is_customizable_pizza && <Badge tone="brand">Personalizable</Badge>}
                </div>
      ...
      <Modal open={formOpen} onClose={() => setFormOpen(false)} widthClass="max-w-lg">
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <FieldLabel>
                  {form.is_customizable_pizza ? 'Precio base (referencia)' : 'Precio'}
                </FieldLabel>
                <Input
                  type="number"
                  step="0.01"
            ...
            <label className="flex items-center gap-2 text-sm font-semibold text-ink-600">
              <input
                ...
                onChange={(e) => setForm({ ...form, is_customizable_pizza: e.target.checked })}
